...
def get_args():
    ...
    parser.add_argument('--load', help='load model',
                        default='/media/kaicao/data2/AutomatedLatentRecognition/models/Minutiae/AEC_net/minutiae_AEC_64_fcn_2/model-224000.index')
    ...
    parser.add_argument('--data', help='a jpeg directory',
                        default='/media/kaicao/data2/AutomatedLatentRecognition/Data/minutiae_cylinder_uint8_MSPLatents_STFT/')
    ...
    parser.add_argument('--log_dir', help='directory to save checkout point', type=str,
                        default='/media/kaicao/data2/AutomatedLatentRecognition/models/Minutiae/AEC_net/minutiae_AEC_64_fcn_2_Latent_STFT/')
